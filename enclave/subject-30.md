...
- Herd: Flock of 3 Mid sized herbivores which always remain docile. User may Pitch appearance of each animal and a corresponding traitM (fluffiness, bounciness…). Will seek out presence of other docile creatures when none are nearby, when left unattended for a while L.

- Cowbell: Will substantiallyM boost intellect of animals it is equipped too, as well as familiarity with user. When equipped to a pacified predator, it will become much more docileH. Soft chime of the bell worn by an animal can be heard by owner regardless of distance.
...
- If not ended before the Duration elapses, the formation will collapse in a way that mostly prevents injury to targetsH+.
...
- In absence of difficult terrain, the ground will shift correspondingly to create a more challenging puzzle.
- User will become aware of the location of relevant puzzle pieces.
Scope of the puzzle scales with relevance of the roadblock.
